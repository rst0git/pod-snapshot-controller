...
import (
	...
	"github.com/rst0git/pod-snapshot-controller/test/utils"
)

// namespace where the project is deployed in
const namespace = "pod-snapshot-controller-system"

// serviceAccountName created for the project
const serviceAccountName = "pod-snapshot-controller"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "pod-snapshot-controller-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "pod-snapshot-controller-metrics-binding"
	...
	Context("Controller", func() {
		It("should run successfully", func() {
			...
			verifyControllerUp := func(g Gomega) {
				...
				cmd := exec.Command("kubectl", "get",
					"pods", "-l", "control-plane=pod-snapshot-controller",
				...
				g.Expect(controllerPodName).To(ContainSubstring("pod-snapshot-controller"))
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=pod-snapshot-controller-metrics-reader",
