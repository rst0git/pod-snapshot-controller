...
var (
	...
	controllerImage = "example.com/pod-snapshot-controller:v0.0.1"
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting pod-snapshot-controller e2e test suite\n")
...
var _ = BeforeSuite(func() {
	...
	// TODO: If you want to change the e2e test vendor from Kind,
